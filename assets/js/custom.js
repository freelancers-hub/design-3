var plexify = function () {
    function n() {
        ...
        function o(e, t) {
            ...
            a.classList.toggle("dark", "dark" === e),
                a.classList.toggle("light", "light" === e),
                (t = "theme"),
                (n = e),
                (e = 30),
    ...
    function a() {
        var e = document.querySelectorAll("button[data-type]");
        let l = document.getElementById("videoDialog"),
            a = document.getElementById("videoContainer");
        ...
        e.forEach((e) => {
            e.addEventListener("click", () => {
                    ...
                    n = e.getAttribute("data-src");
                {
                    let e = "";
                    "youtube" === t || "vimeo" === t
                        ? (e = `<iframe src="${n}?autoplay=1" allow="autoplay; encrypted-media; fullscreen" allowfullscreen></iframe>`)
                        : "mp4" === t &&
                          (e = `<video controls autoplay><source src="${n}" type="video/mp4">Your browser does not support the video tag.</video>`),
                        (a.innerHTML = e),
            ...
            t &&
                t.addEventListener("click", function () {
                    (a.innerHTML = ""), (l.style.display = "none");
                });
    }
    let r = () => {
            function e() {
            ...
            function n(t) {
                ...
                if (n && a.contains(n)) {
                    ...
                    e &&
                        (e.classList.contains("sub-menu") || e.classList.contains("mega-menu")) &&
                        (t.preventDefault(),
                        ...
                        ((e) => {
                            ...
                            if (t) {
                                ...
                                if (t)
                                    for (n of t.children) {
                                        var l = n.querySelector(":scope > a.dz-open");
                                        l &&
                                            l !== e &&
                                            (l.classList.remove("dz-open"), (l = l.nextElementSibling)) &&
                        ...
                        t
                            ...
                            : (n.classList.add("dz-open"),
                              requestAnimationFrame(() => {
                                  (e.style.maxHeight = e.scrollHeight + "px"), requestAnimationFrame(() => s(e));
                              })));
                }
            }
            let l = document.querySelector(".menu-btn"),
                a = document.querySelector(".full-sidenav"),
                o = document.querySelector(".main-bar"),
                r = document.querySelector(".menu-close"),
                s = (e) => {
                    let t = e.parentElement;
                    for (; t; ) {
                        if (t.classList.contains("sub-menu") || t.classList.contains("mega-menu")) {
        ...
        s = (e = document) => {
            e.querySelectorAll(".myAccordion").forEach((a) => {
                "true" !== a.dataset.bound &&
                    ...
                    a.addEventListener("click", function (e) {
                        ...
                        t &&
                            ...
                            (l = t.classList.contains("open")),
                            a.querySelectorAll(".accordion-header").forEach((e) => {
                                e !== t &&
                ...
                e.querySelectorAll(".accordion-header.open").forEach((e) => {
                    ...
                    t && ((t.style.maxHeight = t.scrollHeight + "px"), e?.classList.add("active"));
                });
        },
        i = () => {
                    ...
                    !e.classList.contains("counted") &&
                        ...
                        ((e) => {
                            let t = +e.getAttribute("data-akhi"),
                                ...
                                a = () => {
                                    (n += l) < t
                                        ? ((e.innerText = Math.ceil(n)), requestAnimationFrame(a))
                                        : (e.innerText = t);
                                };
                            a();
                        })(e));
        ...
        c = () => {
            document.querySelectorAll(".input-group").forEach((e) => {
                e.addEventListener("click", function (e) {
                    var t,
                        n,
                        l = e.target.closest(".button-plus, .button-minus");
                    l &&
                        (l.classList.contains("button-plus")
                            ? ((t = e).preventDefault(),
                              (n = (t = t.target.closest("[data-field]")).getAttribute("data-field")),
                              (t = (t.closest("div") || t.closest("td")).querySelector(`input[name="${n}"]`)),
                              (n = parseInt(t.value, 10)),
                              (t.value = isNaN(n) ? 0 : n + 1))
                            : l.classList.contains("button-minus") &&
                              ((t = e).preventDefault(),
                              (n = (t = t.target.closest("[data-field]")).getAttribute("data-field")),
                              (t = (t.closest("div") || t.closest("td")).querySelector(`input[name="${n}"]`)),
                              (n = parseInt(t.value, 10)),
            ...
            document.querySelectorAll(".dynamic-select").forEach((e) => {
                ((n) => {
                    const e = n.id || `select-${Math.random().toString(36).substr(2, 9)}`,
                        ...
                        l = ((t.id = `custom-${e}`), (t.className = "custom-select"), document.createElement("div")),
                        a =
                            ((l.className = "select-selected"),
                            (l.textContent = (n.querySelector("option[selected]") || n.options[0]).textContent),
                    ...
                    (o.className = "select-items select-hide"),
                        t.appendChild(o),
                        Array.from(n.options).forEach((e) => {
                            ...
                            t.addEventListener("click", function () {
                                l.childNodes[0].textContent = this.textContent;
                                n.value = this.getAttribute("data-value");
                                n.dispatchEvent(new Event("change"));
                                n.dispatchEvent(new Event("click"));
                                o.classList.add("select-hide");
                                l.classList.remove("select-active");
                                o.querySelectorAll(".select-item").forEach((e) => e.classList.remove("active"));
                        ...
                        l.addEventListener("click", function (e) {
                            e.stopPropagation();
                            o.classList.toggle("select-hide");
                            l.classList.toggle("select-active");
                        }),
    ...
    return {
        init: function () {
            {
                let a = document.getElementById("scrollProgress");
                var t = document.getElementById("scrolltopbtn");
                if (a) {
                    let l = a.querySelector("circle");
                    if (l) {
                        var e = l.r.baseVal.value;
                        let n = 2 * Math.PI * e;
                        function o() {
                            var e = window.scrollY || document.documentElement.scrollTop,
                                t = e / (document.documentElement.scrollHeight - document.documentElement.clientHeight),
                                t = n * (1 - t);
                            (l.style.strokeDashoffset = t),
                                200 < e ? a.classList.add("active") : a.classList.remove("active");
                        }
                        (l.style.strokeDasharray = "" + n),
                            (l.style.strokeDashoffset = "" + n),
            ...
            r(),
                0 < document.querySelectorAll(".wow").length &&
                    new WOW({ boxClass: "wow", animateClass: "animated", offset: 50, mobile: !1 }).init(),
                s(),
                document.querySelectorAll(".word-rotate").forEach((e) => {
                    var t = e.textContent.trim().split("");
                    let l =
                            (e.classList.contains("third-one") ? 60 : e.classList.contains("one-third") ? 240 : 360) /
                            (t.length - 1),
                        a = e.closest(".word-rotate-box");
                    t.forEach((e, t) => {
                        var n = document.createElement("span");
                        (n.className = "text-char"),
                            n.style.setProperty("--char-rotate", t * l + "deg"),
                            (n.textContent = e),
                            a.appendChild(n);
                    }),
                        e.remove();
                ...
                (e = (e, n, l) => {
                    ...
                    if (e) {
                        ...
                        let t = [document.getElementById(n), document.getElementById(l)];
                        e.noUiSlider.on("update", (e) => {
                            (t[0].innerHTML = "Min Price: $" + e[0]), (t[1].innerHTML = "Max Price: $" + e[1]);
                        });
                    }
                })("slider-tooltips", "slider-margin-value-min", "slider-margin-value-max"),
                e("slider-tooltips2", "slider-margin-value-min2", "slider-margin-value-max2"),
                document.querySelectorAll(".color-filter .form-check-input").forEach((e) => {
                    var t = e.value,
                ...
                document.querySelectorAll(".custom-tab").forEach((t) => {
                    let n = t.querySelectorAll(".tab-title"),
                        a = t.querySelectorAll(".tab-content");
                    n[0]?.classList.add("active"),
                        a[0]?.classList.add("active"),
                        s(a[0]),
                        t.addEventListener("click", (e) => {
                            let l = e.target.closest(".tab-title");
                            l &&
                                t.contains(l) &&
                                n.forEach((e, t) => {
                                    var n = e === l;
                                    e.classList.toggle("active", n),
                                        a[t] && a[t].classList.toggle("active", n),
                                        n && s(a[t]);
                                });
                        });
                });
            ...
            n(),
                i(),
                a(),
                ["lightgallery", "lightgallery2", "lightgallery3", "lightgallery4", "lightgallery5"].forEach((e) => {
                    e = document.getElementById(e);
                    e &&
                        lightGallery(e, {
                ...
                (() => {
                    let l = document.querySelector(".dz-load-more");
                    l &&
                        l.addEventListener("click", function (e) {
                            e.preventDefault();
                            ...
                            (n.className = "fa fa-refresh"),
                                l.appendChild(n),
                                fetch(e, { method: "POST", headers: { "Content-Type": "text/html" } })
                                    .then((e) => e.text())
                                    .then((e) => {
                                        var t = document.querySelector(".loadmore-content");
                                        t && t.insertAdjacentHTML("beforeend", e), l.removeChild(n);
                                    })
                                    .catch(() => {
                                        n.parentNode === l && l.removeChild(n);
                                    });
                        });
                })(),
                (() => {
                ...
                (() => {
                    ...
                    document.querySelectorAll(".btn").forEach((n) => {
                        let l = n.querySelector(".pxl-button-text");
                        if (l) {
                            let t = l.textContent.trim();
                            (l.dataset.originalText = t),
                                n.addEventListener("mouseenter", () => {
                                    var e;
                                    a.has(n) ||
                                        (a.add(n),
                                        (e = [...t]
                                            .map((e) => `<span class="letter">${" " === e ? "&nbsp;" : e}</span>`)
                                            .join("")),
                                        (l.innerHTML = e),
                                        (e = l.querySelectorAll(".letter")),
                                        gsap.fromTo(
                                            e,
                                            { opacity: 0, y: -10 },
                                ...
                                n.addEventListener("mouseleave", () => {
                                    (l.innerHTML = l.dataset.originalText), a.delete(n);
                                });
                        }
                    }),
                ...
                (() => {
                    ...
                    for (e of document.getElementsByClassName("current-year")) e.innerHTML = t;
                })(),
                ...
                0 < document.querySelectorAll(".star-rating-old").length && new StarRating(".star-rating-old");
            t = document.querySelector(".dz-form.footer-form");
            if (t) {
                let e = t.querySelectorAll('input[required]:not([type="hidden"]), textarea[required]'),
                    n = t.querySelector(".input-recaptcha");
                function l() {
                    let t = !0;
                    return (
                        e.forEach((e) => {
                            null === e.offsetParent || (e.value && "" !== e.value.trim()) || (t = !1);
                        }),
                    ...
                    (() => {
                            ...
                            t =
                                (0 < e.length &&
                                    (0 < (t = document.querySelectorAll(".filters li")).length &&
                                        (t.forEach((e) => e.classList.remove("active")), t[0].classList.add("active")),
                                    e.forEach((t) => {
                        ...
                        if (e) {
                            ...
                            0 < n.length &&
                                ...
                                n.forEach((t) => {
                                    t.addEventListener("click", () => {
                                        n.forEach((e) => e.classList.remove("active")), t.classList.add("active");
...
window.addEventListener("load", function () {
    ...
    window.addEventListener("scroll", function () {
        void 0 !== plexify && "function" == typeof plexify.scroll && plexify.scroll();
    }),
